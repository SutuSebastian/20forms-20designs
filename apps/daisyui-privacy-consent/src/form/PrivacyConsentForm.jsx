  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="form-control w-full">
        <label className="label" htmlFor="daisyui-privacy-name">
          <span className="label-text">Full name</span>
        </label>
        <input
          id="daisyui-privacy-name"
          name="fullName"
          type="text"
          required
      ...
      <div className="form-control w-full">
        <label className="label" htmlFor="daisyui-privacy-email">
          <span className="label-text">Email address</span>
        </label>
        <input
          id="daisyui-privacy-email"
          name="email"
          type="email"
          required
          className="input input-bordered w-full"
      ...
      <fieldset className="space-y-2">
        <legend className="text-base font-medium">Privacy options</legend>
        <div className="form-control">
          <label className="label cursor-pointer justify-start gap-2">
      ...
      <div className="form-control w-full">
        <label className="label" htmlFor="daisyui-privacy-notes">
          <span className="label-text">Additional notes</span>
        </label>
        <textarea
          id="daisyui-privacy-notes"
          name="notes"
          rows="3"

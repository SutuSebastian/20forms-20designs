import { InputField, Button, Stack, Select, Textarea, Checkbox, Heading, Separator } from '@kiwicom/orbit-components'
  ...
  return (
    <form onSubmit={handleSubmit}>
      <Stack direction="column" spacing="medium">
        ...
        <Select label="Team size" name="teamSize" options={sizeOptions} required />
        ...
        <Stack direction="row" spacing="small">
          <Button type="secondary" onClick={() => alert('Back action placeholder')}>Back</Button>
          <Button type="primary" submit>Finish setup</Button>
        </Stack>
      </Stack>
    </form>
  )

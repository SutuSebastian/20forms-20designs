  ...
  return (
    <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <Box component="fieldset" sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 1, p: 2 }}>
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox name="emailOptIn" />} label="Email updates" />
          <FormControlLabel control={<Checkbox name="smsOptIn" />} label="SMS notifications" />
          <FormControlLabel control={<Checkbox name="phoneOptIn" />} label="Phone calls" />
        </FormGroup>
      </Box>
      ...
      <Box component="fieldset" sx={{ border: '1px solid', borderColor: 'divider', borderRadius: 1, p: 2 }}>
        ...
        <FormGroup>
          <FormControlLabel control={<Checkbox name="analytics" />} label="Allow analytics cookies" />
          <FormControlLabel
